import React, { useEffect, useState } from 'react'
  ...
  const Slider = () => {
      const spaceId="6696a3c491c70d03d7f324cd";
          ...
          {slidesDetails.isAutoplay && <Swiper
              ...
              >
                  {testimonials.map((testi, index)=>{
                      ...
                      py-5 px-10 bg-gradient-to-tr from-[#FFDEE9] to-[#B5FFFC]
                      transition-all duration-300 flex flex-row items-center justify-center`}>
                        <div className={`text-center text-lg text-gray-600   relative w-full
                        text-2xl`}>
                        ...
                        <div className={`w-full flex flex-col items-center justify-start gap-0 text-gray-900`}>
