...
const CreateSpace = () => {
  ...
  const handleSubmit=async()=>{
    ...
    try{
      ...
      const res=await axios.post("http://localhost:3000/api/v1/createSpace", formData, {
        headers: {
    ...
    <div className="w-screen bg-gray-100 py-10 h-screen">
      <div className="max-w-[1300px] mx-auto py-10 form bg-white shadow-sm shadow-gray-400 h-full rounded-md flex flex-row items-start justify-start">
        ...
        <div className="right w-[50%] flex flex-col items-center justify-start gap-4 py-14 px-10">
            ...
            <div className="text-3xl text-gray-800 font-semibold">Create a new Space</div>
            {/* <div></div> */}

            <div className="w-[80%] text-center text-gray-700">After the Space is created, it will generate a dedicated page for collecting testimonials.</div>
            ...
            <div className="btn bg-purple-500 text-white w-full text-center py-2 rounded-md" onClick={handleSubmit}>Create new space</div>
